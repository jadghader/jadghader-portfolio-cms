...
import { ReactComponent as LightErrorIllustration } from "../../assets/light/404-error-light.svg"; // Light theme SVG
import { ReactComponent as DarkErrorIllustration } from "../../assets/dark/404-error-dark.svg"; // Dark theme SVG
  ...
  return (
    <Container deviceType={deviceType}>
      <Content deviceType={deviceType}>
        <IllustrationWrapper deviceType={deviceType} isDarkMode={isDarkMode}>
          {isDarkMode ? <DarkErrorIllustration /> : <LightErrorIllustration />}
        </IllustrationWrapper>
...
const IllustrationWrapper = styled.div<{
  ...
  width: ${({ deviceType }) =>
    deviceType === "mobile" ? "80%" : deviceType === "tablet" ? "40%" : "40%"};
  max-width: 400px;
  display: flex;
  justify-content: center;
  align-items: center;
